...
class GostR3411_2012_512Digest extends AbstractDigest {
    private static final byte[] ATTR_GOSTR3411_2012_512 = {0x06, 0x08, 0x2a, (byte) 0x85, 0x03,
                                                           0x07, 0x01, 0x01, 0x02, 0x03};
    ...
    public byte[] digest(final byte[] data) throws Pkcs11Exception {
        return innerDigest(makeMechanism(RtPkcs11Constants.CKM_GOSTR3411_12_512, ATTR_GOSTR3411_2012_512), data);
    }
